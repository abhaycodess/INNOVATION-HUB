              ...
              <Card sx={{ borderRadius: 4, boxShadow: 'none', bgcolor: '#f1f5f9' }}>
                <CardContent sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, flexDirection: 'column' }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mt: 1 }}>
                    ...
                    <Tooltip title="Share">
                      <IconButton onClick={() => handleShare(idx)}>
                        <ShareOutlinedIcon />
                      </IconButton>
                    </Tooltip>
                  </Box>
                  ...
                  {showComments[idx] && (
                    <Box sx={{ mt: 2, width: '100%' }}>
                      ...
                      <Box sx={{ display: 'flex', gap: 1 }}>
                        ...
                        />
                        <Button variant="contained" size="small" onClick={() => handleAddComment(idx)} sx={{ bgcolor: '#38bdf8', color: '#fff', fontWeight: 700, boxShadow: 'none', '&:hover': { bgcolor: '#0ea5e9' } }}>
                          Post
                        </Button>
                      </Box>
                    </Box>
